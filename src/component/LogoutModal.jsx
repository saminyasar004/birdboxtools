...
const LogoutModal = ({ isVisible, onClose, logout }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-600bg-opacity-50">
      <div className="absolute top-24 w-full px-[15px] mx-auto sm:max-w-[540px] md:max-w-[720px] lg:max-w-[1150px] xl:max-w-[1150px]">
        <div className="m-auto flex justify-center items-center w-fit rounded-[5px]">
          <div className="bg-[#090909] border-t-2 border-t-primary shadow-2xl rounded-lg p-4 min-w-full md:min-w-[420px]">
            <div className="flex flex-col items-center justify-center gap-4">
              ...
              <p className="text-t_color">Do you want to logout?</p>
            </div>
            <hr className="my-4" />
            <div className="flex justify-between w-full items-center gap-4 ">
              <button
                type="button"
                className="btn bg-[#1E5DCC] text-t_color   "
                style={{
                  borderRadius: "5px",
                  height: "40px",
                  padding: "8px 24px",
